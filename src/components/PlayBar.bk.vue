<template>
  <el-row type="flex" justify="space-around">
    <el-col :span="17"  id="palyerController" >
      <el-row type="flex" align="middle" justify="center" :gutter="20">
        <el-col :span="4">
          <!-- 音乐切换、播放、暂停 -->
          <el-row type="flex" justify="center" >
            <el-col :span="8"><div id="forwardBtn" class="forwardBtn conBtn"></div></el-col>
            <el-col :span="8"><div id="playBtn" class="playBtn conBtn" @click="playORpause" :class="{pauseBtn: isPause}"></div></el-col>
            <el-col :span="8"><div id="nextBtn" class="nextBtn conBtn"></div></el-col>
          </el-row>
        </el-col>
        <el-col :span="10">
          <!-- 音乐播放进度 -->
